...
const Navbar =() =>{
  ...
  return (
    ...
    {toggleMenu ?
      ...
      {toggleMenu && (
        <ul className='z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen shadow=2xl md:hidden list-none flex flex-col jutify-start item-end rounded-md blue-glassmorphism text-white animate-slide-in'>
